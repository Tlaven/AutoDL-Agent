...
test_supervisor_multiturn:
	uv run pytest tests/integration_tests/supervisor_agent/test_supervisor_multiturn_state_evolution.py -q

test_supervisor_contract:
	uv run pytest tests/integration_tests/supervisor_agent/test_supervisor_internal_trajectory.py tests/integration_tests/supervisor_agent/test_supervisor_multiturn_state_evolution.py tests/integration_tests/supervisor_agent/test_supervisor_executor_result_contract.py -q


test_supervisor_key:
	uv run pytest tests/unit_tests/supervisor_agent tests/integration_tests/supervisor_agent/test_supervisor_smoke.py tests/integration_tests/supervisor_agent/test_supervisor_internal_trajectory.py tests/integration_tests/supervisor_agent/test_supervisor_multiturn_state_evolution.py tests/integration_tests/supervisor_agent/test_supervisor_executor_result_contract.py tests/e2e_tests/supervisor_agent/test_supervisor_e2e_smoke.py -q
...
help:
	...
	@echo 'test_supervisor_multiturn    - run supervisor multi-turn state evolution tests'
	@echo 'test_supervisor_contract     - run supervisor contract tests (trajectory+multiturn)'
	@echo 'test_supervisor_key          - run supervisor key gate tests (unit+smoke+trajectory+multiturn+contract+e2e)'
